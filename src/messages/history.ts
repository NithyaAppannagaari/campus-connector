...
export const HISTORY: EventRecord[] = [
  ...
  { source: "luma", category: "club", title: "ML @ Georgia Tech GM", attendedWith: ["dev"], outcome: "joined", daysAgo: 8, hour: 19 },
...
export const CANDIDATES: CandidateEvent[] = [
  {
    ...
    source: "partiful",
    category: "party",
    title: "F1 watch party @ Student Center",
    when: "Tonight 8 PM",
    hour: 20,
  ...
  },
  {
    ...
    source: "luma",
    category: "hobby",
    title: "Board game night @ Clough (CULC)",
    when: "Tomorrow 7 PM",
    hour: 19,
    friendsGoing: ["priya"],
    demoAt: 2000,
