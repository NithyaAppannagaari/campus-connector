import {
  Building, COLS, POOL, Pt, ROWS, TECH_GREEN, TECH_TOWER, TILE, Tile, Vibe, W, World, doorTile,
} from "./world";
...
function drawBuilding(
  ...
  if (b.id === "stadium") {
    ...
    const fw = pw - 24;
    const fh = ph - 26;
    ctx.fillStyle = open ? "#3c9c4a" : "#3a7a44";
  ...
  ctx.fillStyle = b.id === "crc" ? "#4a3520" : WOOD;
...
export function draw(
  ...
  ctx.fillText("NORTH AVE", 18 * TILE, 26.15 * TILE);
